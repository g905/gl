...
public class MD5AnimHeader {
    ...
    public String toString() {
        return "animHeader: [version: " + version + ", commandLine: " + commandLine + ", numFrames: " + numFrames + ", numJoints: " + numJoints + ", frameRate: " + frameRate + ", numAnimatedComponents: " + numAnimatedComponents + "]";
    }
